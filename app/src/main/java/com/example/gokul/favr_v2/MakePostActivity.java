...
public class MakePostActivity extends ActionBarActivity {
    Toolbar mToolbar;
    Button btnThought;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayout = (LinearLayout) this.findViewById(R.id.ll2);
        linearLayout.setVisibility(View.INVISIBLE);
        final ListView listView = (ListView) this.findViewById(R.id.addOptionListView);


        final ArrayList<Integer> deleteList = new ArrayList<Integer>();
        final ArrayList<Integer> editList = new ArrayList<Integer>();

        final AddBidOptionListAdapter adapter = new AddBidOptionListAdapter(this, deleteList, editList, optionList);
        listView.setAdapter(adapter);
        ImageButton optionAddButton = (ImageButton) this.findViewById(R.id.btn);
        editOptionInput = (EditText) this.findViewById(R.id.editOptionInput);
        ...
        btnThought = (Button) this.findViewById(R.id.btnThought);
        btnPrediction = (Button) this.findViewById(R.id.btnPrediction);
        btnQuestion = (Button) this.findViewById(R.id.btnQuestion);

        editPost = (EditText) this.findViewById(R.id.tv);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.toSettings){
            ...
            Intent postSettingsIntent;
            postSettingsIntent = new Intent(MakePostActivity.this, PostSettingsActivity.class);
          ...
          //  String currentUsername = currentUser.getUsername();
           ...
           /* switch (postType){
            ...
            postSettingsIntent.putExtra("post", newPost);
            postSettingsIntent.putExtra("postType", postType);

            postSettingsIntent.putStringArrayListExtra("bidOptionList", optionList);
            ...
            startActivity(postSettingsIntent);
